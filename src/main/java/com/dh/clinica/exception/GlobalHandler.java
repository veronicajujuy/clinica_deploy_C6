...
public class GlobalHandler {
    ...
    @ExceptionHandler(BadRequestNewException.class)
    public ResponseEntity<ApiError> manejarExcepcionesBadRequest(BadRequestNewException e, HttpServletRequest request){
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                e.getMessage(),
